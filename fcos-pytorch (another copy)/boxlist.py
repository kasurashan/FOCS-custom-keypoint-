...
class BoxList:
    #def __init__(self, box, image_size, mode='xyxy'):   ######### edit (keypoint)
    ...
    def convert(self, mode):
        ...
        if mode == 'xyxy':
            ...
            box = BoxList(box, self.key, self.size, mode=mode)############ edit 
    ...
    def resize(self, size, *args, **kwargs):
        ...
        if ratios[0] == ratios[1]:
            ...
            scaled2 = self.key * ratio   ######### add (keypoint)
        ...
        scaled_key_x = self.key[:,0] * ratio_w   ######### add (keypointt)
        ...
        box = BoxList(scaled, scaled2, size, mode='xyxy') ############# edit (keypoint)
    ...
    def transpose(self, method):
        ...
        box = BoxList(transpose_box, self.key, self.size, mode='xyxy')################## edit(keypoint)
    ...
    def to(self, device):
        ...
        box = BoxList(self.box.to(device), self.key, self.size, self.mode)   #### edit (self.key)
